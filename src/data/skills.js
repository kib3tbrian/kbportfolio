...
const skills = [
  ...
  { 
    ...
    skills: [
      { name: 'Airflow', level: 90, color: 'bg-blue-800' },
      { name: 'Kafka', level: 80, color: 'bg-teal-500' },
      { name: 'Spark', level: 75, color: 'bg-green-700' },
  ...
  { 
    ...
    skills: [
      ...
      { name: 'Terraform', level: 80, color: 'bg-teal-500' }
    ]
  }
];
